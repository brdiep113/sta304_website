...
## Part I. Introduction
  ...
  The divide between English and French Canadians has historically been the source of much social tension in this country. Franco-Canadians have historically found themselves in opposition to and oppressed by the English majority. This disparity can bee seen in historical records. The goal of this analysis is to find any gaps between these two groups that can be seen in contemporary Canadian society, as a result of these tensions. Through our cursory look through the de. We find that overall, the gap between English and French-Canadians has closed and that they have roughly the same levels of income, educational attainment, and employment.
...
Looking at the data, we see overall that the distribution between. This suggests that many of the socioeconomic gaps between English and French Canadian society have closed. 

## Limitations and Next Steps

  For the sake of transparency, a few limitations may have affected the results and conclusions made in this study. In particular, we did not take into account the province of residence of respondents. This is particularly an issue as the distribution of English and French speakers in Canada remains extremely stratified between provinces. For example, the majority of Francophones are found in Quebec and New Brunswick.[cite] Quebec is also unique in that it serves as an outlier since it is the only province with a Francophone majority.[cite] Therefore, the experience of being an English Canadian is likely to be much more different in Quebec than in other English majority provinces.
  
  We also fail to take into account bilingual speakers of both English and French. This also poses an additional challenge as native francophones are much more likely to be bilingual than their allophone counterparts.[cite]
